...
namespace QuanLyTaiSanTest.Controllers
{
    ...
    public class AssetController : ControllerBase
    {
        ...
        [HttpGet("GetPageList")]
        public async Task<IActionResult> GetPageList(int pageIndex = 1, int pageSize = 5, string? searchName = null, int? status = null, int? categoryId = null, string? userId = null, int? departmentId = null, string sortBy = "date", bool desc=true )
        {
            ...
            try
            {
                ...
                return Ok( await _assetService.GetPageList(pageIndex, pageSize, searchName, categoryId, userId, departmentId , status, sortBy, desc));
            }
            catch (KeyNotFoundException ex)
            {
                return Ok(new ApiResponse<string>
